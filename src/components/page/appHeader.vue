    ...
    <nav class="container nav">
      <div class="nav__container">
        <button
          ...
          @click="closeMenu"
        >
          <img :src="getImgUrl('icon-close.svg')" alt="X" />
        </button>
        <button
          v-if="!visibleMenu"
          ...
          @click="showMenu"
        >
          <img :src="getImgUrl('icon-menu.svg')" alt="" />
        </button>
        <img :src="getImgUrl('wears.png')" alt="Wears logo" />
