<template>
  <div class="cart">
    ...
    >
      ...
      />
      <app-button class="padding-y--small">Checkout</app-button>
    </div>
...
<script>
import appCartItem from '@/components/page/appCartItem.vue';
import appButton from '@/components/page/appButton.vue';

export default {
  components: { appCartItem, appButton },
  props: {
    cart: {
      type: Array,
      default() {
